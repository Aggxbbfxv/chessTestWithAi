...
static constexpr auto qt_meta_stringdata_ZN16ChessBoardWidgetE = QtMocHelpers::stringData(
    "ChessBoardWidget",
    "startGame",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16ChessBoardWidgetE[] = {
...
Q_CONSTINIT const QMetaObject ChessBoardWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16ChessBoardWidgetE.offsetsAndSizes,
    qt_meta_data_ZN16ChessBoardWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16ChessBoardWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChessBoardWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16ChessBoardWidgetE.stringdata0))
