...
public:
    ...
    static Move findBestMove(const Game& game, Piece::PieceColor aiColor);

    static int nodeCount;

private:
    static int alphabeta(Game& state, int depth, int alpha, int beta, bool maxing, Piece::PieceColor aiColor);

    static int eval(const Game& board, Piece::PieceColor colorToMax);
